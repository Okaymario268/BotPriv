...
def get_left_mm():    return _call("get_left_mm")       # left side ranger, mm (-1 open, None = RPC fail)
def get_right_mm():   return _call("get_right_mm")      # right side ranger, mm (-1 open, None = RPC fail)
