...
after corner #12 drives back ONTO ITS START POSITION and stops there: the front
ultrasonic re-reads the distance fingerprint sampled at start (fsm.py FINISH).
